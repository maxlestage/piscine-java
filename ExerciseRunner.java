...
public class ExerciseRunner {
    public static void main(String[] args) {
        ...
        // ListSearchIndex
        System.out.println(ListSearchIndex.findLastIndex(List.of(9, 13, 89, 8, 89, 23, 1, 0, 89), 89));
        ...
        System.out.println(
                ListSearchIndex.findAllIndexes(List.of(43784, 327, 43784, 1903, 3847, 43784, 327, 327, 3289), 43784));
        System.out.println(
        ...
        System.out.println(ListSearchIndex.findAllIndexes(List.of(43784, 327, 1903, 3847, 327, 327, 3289), 489));
